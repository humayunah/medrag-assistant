...
const navItems = [
  { to: "/dashboard", label: "Documents", icon: DocIcon },
  { to: "/query", label: "Ask AI", icon: ChatIcon },
];
    ...
    <div className="min-h-screen flex bg-[#faf7f2]">
      ...
      <aside className="w-64 bg-[#0f172a] text-white flex flex-col shrink-0">
        ...
        <div className="px-6 py-5 border-b border-white/10">
          ...
          >
            Med<span className="text-amber-500">RAG</span>
          </h1>
...
/* ── Inline SVG icons (kept small, no extra dependency) ── */
